//
//  DDTableViewAdapterViewController.swift
//  Example
//
...
class DDTableViewAdapterViewController: UIViewController {
    ...
    override func viewDidLoad() {
		...
		self.title = "直接使用DDTableViewAdapter"
